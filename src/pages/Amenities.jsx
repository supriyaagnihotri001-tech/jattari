        ...
        <div className="relative z-10 mx-auto flex min-h-[78vh] max-w-7xl items-center px-6 py-28 sm:px-8 lg:px-10">
          <div className="max-w-3xl">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <Link
                to="/book-site-visit"
                className="inline-flex items-center justify-center gap-3 bg-[#d8b56d] px-7 py-4 text-sm font-semibold uppercase tracking-wider text-[#102d25] transition hover:bg-[#efd99f]"
              >
                Book a Site Visit
                <ArrowRight size={18} />
              </Link>
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center border border-white/30 bg-white/5 px-7 py-4 text-sm font-semibold uppercase tracking-wider text-white backdrop-blur-md transition hover:bg-white/10"
              >
                Talk to Us
              </Link>
            </div>
          ...
          <div className="mb-14 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            <div>
              ...
              <h2 className="mt-4 max-w-3xl font-serif text-4xl leading-tight sm:text-5xl lg:text-6xl">
                Designed around
                <span className="text-[#d8b56d]"> your lifestyle.</span>
              </h2>
            </div>
          ...
          <div className="grid gap-px overflow-hidden border border-white/10 bg-white/10 sm:grid-cols-2 lg:grid-cols-3">
            {amenities.map((item) => {
              ...
              return (
                <div
                  key={item.number}
                  className="group bg-[#102d25] p-7 transition duration-500 hover:bg-[#17382f] sm:p-9"
                >
      ...
      <section className="px-6 py-20 sm:px-8 lg:px-10 lg:py-28">
        <div className="mx-auto max-w-5xl border border-[#d8b56d]/40 bg-[#eee7d8] px-7 py-14 text-center sm:px-12 lg:py-20">
          ...
          <h2 className="mt-5 font-serif text-4xl sm:text-5xl lg:text-6xl">
            See the lifestyle
            <span className="text-[#a88343]"> in person.</span>
          </h2>
          ...
          <Link
            to="/book-site-visit"
            className="mt-8 inline-flex items-center gap-3 bg-[#102d25] px-8 py-4 text-sm font-semibold uppercase tracking-wider text-white transition hover:bg-[#17382f]"
          >
            Schedule Site Visit
            <ArrowRight size={18} />
          </Link>
